...
function preload() {
	$("section, .video .swiper-container, .video .swiper-slide").height($(window).height());
	var c = $("section.video .swiper-container .swiper-slide:lt(2)");
	if (pageIndex > 0 && pageIndex < $("section").size()) c = $("section").eq(pageIndex);
	preloadCount = c.size();
	c.each(function(i, a) {
...
function sectionAnimation() {
	...
	var e = $("section").eq(pageIndex).addClass("active");
	if (pageIndex == 2) {
		var b = $(".cases a.prev");
		var c = $(".cases a.next");
...
function pageSwitching() {
	...
	$("html,body").stop().animate({
		scrollTop: $("section").eq(pageIndex).offset().top
	}, 300, "swing", function() {
		if (a) return;
		else a = true;
		resetVideoSwiperAnimation();
