          ...
          return (
            ...
            g === f
              ...
              : ("undefined" == typeof d && (d = !0),
                v(g, "to", { index: a, speed: c, runCallbacks: d }),
                !0)
          );
        }
      }),
...
function preload() {
  $("section, .video .swiper-container, .video .swiper-slide").height(
    $(window).height()
  );
  var c = $("section.video .swiper-container .swiper-slide:lt(2)");
  if (pageIndex > 0 && pageIndex < $("section").size())
    c = $("section").eq(pageIndex);
  preloadCount = c.size();
  c.each(function(i, a) {
...
function pageLoad() {
  ...
  // $("header .logo").append('<img src="../../../static/iotosHome/images/logo_mini.png" class="img-responsive mini" />');
  ...
  $("header .menu-icon span.glyphicon-th-large").bind(
    "click touchstart",
    function() {
      ...
      if ($(this).hasClass("active")) {
        ...
        // $(document.querySelector(".center")).addClass("hidden");
      } else {
        $(this).addClass("active");

        $("header .menu").addClass("active");
        $("header").addClass("active");
        // $(document.querySelector(".center")).removeClass("hidden");
      }
    }
  );
  ...
  $(".video .guide a")
    .eq(0)
    .addClass("active");
  $(".video .nth1, .video .nth2").append(
    '<div class="shade"></div><div class="line"><u></u></div>'
  );
  videoSwiper = new Swiper(".video .swiper-container", {
    ...
    onSlideChangeEnd: function() {
      $(".video .guide a")
        .removeClass("active")
        .eq(videoSwiper.activeLoopIndex)
        .addClass("active");
  ...
  $(".video .guide a")
    .bind("mouseover click touchstart", function(e) {
      e.preventDefault();
      videoSwiper.stopAutoplay();
  ...
  $(".cases .swiper-container")
    .after(
      '<a class="prev" href="javascript:;"></a><div class="swiper-container mini">' +
        $(".cases .swiper-container").html() +
  ...
  $(".cases .swiper-slide a")
    .prepend('<div class="shade"><u></u></div>')
  ...
  $(".clients ul.items").after(
    '<ul class="mini list-inline">' + $(".clients ul.items").html() + "</ul>"
  );
  ...
  $(".quality .swiper-container").after(
    '<a class="prev" href="javascript:;"></a><div class="swiper-container mini">' +
      $(".quality .swiper-container").html() +
      '</div><a class="next" href="javascript:;"></a>'
  );
  ...
  $(".aboutus .exp").after(
    '<div class="expBg"></div><div class="shade"></div>'
  );
  ...
  $(window).bind("resize", function(e) {
    ...
    $(b).bind(whichTransitionEvent(), function() {
      ...
      $(".dock").css(
        "top",
        ($(window).height() - $(".dock").height()) / 2 + 35
      );
    });
  });
  dockEvent();
  ...
  if (g == undefined) {
    initLayout();
    var h =
      '$("div.welcome").animate({opacity:"0", zIndex:"-1"}, 500, "swing", function(){ pageSwitching(); })';
    setTimeout(h, 600);
    pageSwitching();
  } else {
    $("div.welcome").animate(
...
function initLayout() {
  ...
  if ($(window).width() > 1000) {
    ...
    var j =
      g.outerWidth() * g.size() + h * 2 * g.size() + 4 * (g.size() - 1) + 2;
  ...
  g = $(".aboutus .items");
  itemsTop = parseInt(
    ($(window).height() - g.height() + e - $(".aboutus table.exp").height()) / 2
  );
  g.css("top", itemsTop);
...
function videoSwiperAnimation() {
  var e = $(
    ".video .swiper-container .nth" +
      (videoSwiper.activeLoopIndex + 1).toString()
  ).addClass("active");
...
function sectionAnimation() {
  ...
  if (pageIndex == 2) {
    ...
    var f = parseInt(
      $(".clients ul.items").height() / $(".clients ul.items li.one").height()
    );
    var g = parseInt(
      $(".clients ul.items").width() / $(".clients ul.items li.one").width()
    );
...
function pageSwitching() {
  ...
  if (pageIndex >= $("section").size()) {
    pageIndex = $("section").size() - 1;
    stopSwitch = false;
    return;
  }
  var a = false;
...
function dockEvent() {
  $(".dock")
    .height(
      $(".dock ul.icons li").length * 50 + $(".dock a.switch").height() + 20
    )
    .css("top", ($(window).height() - $(".dock").height()) / 2 + 35);
