$(function() {
  ...
  $(".toolbar .switch").after(
    "<div class='logo'><a href='http://www.1000zhu.com/'><img src='" +
  ...
  if ($("section.artshow").size() > 0) {
    $("section.content").append(
      "<div class='footWechat'>" + $("header .wechat").html() + "</div>"
    );
...
function setArtshow() {
  ...
  var e = parseInt(
    ($(window).height() - $(".artshow aside").outerHeight()) / 2
  );
  $(".artshow aside")
    .css("top", e)
    .addClass("active");
...
function setCaselist() {
  ...
  var w =
    $(window).width() - $(".caselist ul.items li").width() * c - d * c * 2 + 5;
